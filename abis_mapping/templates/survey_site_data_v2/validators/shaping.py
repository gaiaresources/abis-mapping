"""Generates a SHACL shape graph for the survey_site_data template."""
...
def main() -> None:
    ...
    d = rdflib.Graph().parse(source="abis_mapping/templates/survey_site_data_v2/examples/minimal.ttl")
    ...
    # Write out to file
    g.serialize("abis_mapping/templates/survey_site_data_v2/validators/validator.ttl")
