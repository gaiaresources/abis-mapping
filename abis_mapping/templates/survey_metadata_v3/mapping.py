...
CONCEPT_TARGET_HABITAT_SCOPE = rdflib.URIRef(
    "http://linked.data.gov.au/def/tern-cv/602de488-eb66-4e59-a2e7-64386caa6948"
)  # updated
            ...
            for raw_org in survey_orgs:
                survey_org_objects.append(
                    SurveyIDDatatype(
                        ...
                        attribution=utils.iri_patterns.attribution_iri("principalInvestigator", raw_org),
