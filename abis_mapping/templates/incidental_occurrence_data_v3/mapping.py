...
CONCEPT_DATA_GENERALIZATIONS = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/77f30c7d-4642-45a4-ab91-1400bf2bc652")  # real URI
CONCEPT_TAXON_RANK = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/1e4d7110-5f07-45ec-98e7-738236a8d8e0")  # real URI
CONCEPT_INDIVIDUAL_COUNT = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/74c71500-0bae-43c9-8db0-bd6940899af1")
CONCEPT_ORGANISM_REMARKS = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/54137592-31ab-4de2-98b5-9677274ff93c")  # real URI
CONCEPT_HABITAT = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/2090cfd9-8b6b-497b-9512-497456a18b99")
CONCEPT_BASIS_OF_RECORD = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/633119a9-6c8a-46ae-a78a-23a4fd371eb2")  # real URI
CONCEPT_OCCURRENCE_STATUS = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/835d7166-2a4d-4335-9d39-8082ff201811")  # real URI
CONCEPT_PREPARATIONS = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/9694c614-7bb5-4403-bba4-fd01d40bf5c3")  # real URI
CONCEPT_ESTABLISHMENT_MEANS = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/58eaac1c-4c8b-4a95-897f-86dfc83e660f")  # real URI
CONCEPT_LIFE_STAGE = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/7e142859-c559-417e-a725-4b547f7e722c") # updated
CONCEPT_SEX = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/05cbf534-c233-4aa8-a08c-00b28976ed36")
CONCEPT_REPRODUCTIVE_CONDITION = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/4b2e788d-260b-4cfc-91f4-99e7c2ad2c42")  # real URI
CONCEPT_ACCEPTED_NAME_USAGE = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/e11cc022-7368-435b-96c5-a7f8c7f61a50")  # real URI
CONCEPT_NAME_CHECK_METHOD = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/526319d0-0210-42b0-bd4c-fa18585ab6f2")  # real URI
CONCEPT_SEQUENCE = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/28d76c6c-6ee0-4bec-8adf-634cadb52aef")  # real URI
...
CONCEPT_ORGANISM_QUANTITY = rdflib.URIRef("http://linked.data.gov.au/def/tern-cv/36b0f572-7215-42c0-a904-88619d23b4d0")  # real URI
