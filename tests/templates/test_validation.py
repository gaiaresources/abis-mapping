...
@pytest.mark.parametrize(
    ...
    argvalues=[(id, params) for (_, id, params) in conftest.mapping_test_args() if "incidental" not in id],
    ids=[id for (id, _, params) in conftest.mapping_test_args() if "incidental" not in id],
)
